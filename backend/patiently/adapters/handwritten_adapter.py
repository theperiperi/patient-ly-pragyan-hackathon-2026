...
from patiently.core.base_adapter import BaseAdapter, PatientIdentity, AdapterResult
from patiently.core.fhir_helpers import (
...
from patiently.api.vlm_client import VLMClient, MockVLMClient
